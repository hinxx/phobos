...
public class SimProposalProvider implements PVProposalProvider
{
    ...
    private static final List<SimProposal> all_proposals = List.of(
        ...
        new SimProposal("sim://polarangle", "pair_id"),
        new SimProposal("sim://polarangle", "pair_id", "max_radius", "steps", "update_seconds"),
        new SimProposal("sim://polarradius", "pair_id"),
        new SimProposal("sim://polarradius", "pair_id", "max_radius", "steps", "update_seconds"),
